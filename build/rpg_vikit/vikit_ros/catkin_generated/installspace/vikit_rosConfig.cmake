...
if(NOT "include;/usr/include/eigen3;/usr/include/opencv;/usr/include;/root/dependencies/Sophus " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vikit_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/install/${idir}'.  Ask the maintainer 'cforster <forster@ifi.uzh.ch>' to fix it.")
    endif()
